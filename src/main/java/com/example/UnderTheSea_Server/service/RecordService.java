...
public class RecordService {
    ...
    //기록 저장하기
    @Transactional
    public PostRecordRes createRecord(PostRecordReq postRecordReq, User userbyjwt) throws BaseException {
        try{
            //기록 db에 insert하기
...
//    public PutRecordRes updateRecord(PutRecordReq putRecordReq) throws BaseException {
//        try{
//
//            //계획 db에서 update하기
//            RecordRepository.updateImgAndContent(
//                    putRecordReq.img_url,
